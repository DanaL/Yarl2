...
class PocketDimension
{
  ...
  public static (Loc, Dungeon) WhaleBelly(Actor monster, GameState gs)
  {
    ...
    map.SetTile(0, 5, TileFactory.Get(TileType.WorldBorder));
    map.SetTile(0, 6, TileFactory.Get(TileType.WorldBorder));
    map.SetTile(0, 7, TileFactory.Get(TileType.WorldBorder));
    map.SetTile(0, 8, TileFactory.Get(TileType.WorldBorder));
    map.SetTile(0, 9, TileFactory.Get(TileType.WorldBorder));
    map.SetTile(0, 10, TileFactory.Get(TileType.WorldBorder));
    map.SetTile(0, 11, TileFactory.Get(TileType.WorldBorder));
    ...
    map.SetTile(4, 5, TileFactory.Get(TileType.WorldBorder));
    map.SetTile(4, 6, TileFactory.Get(TileType.WorldBorder));
    map.SetTile(4, 7, TileFactory.Get(TileType.WorldBorder));
    map.SetTile(4, 8, TileFactory.Get(TileType.WorldBorder));
    map.SetTile(4, 9, TileFactory.Get(TileType.WorldBorder));
    map.SetTile(4, 10, TileFactory.Get(TileType.WorldBorder));
    map.SetTile(4, 11, TileFactory.Get(TileType.WorldBorder));
