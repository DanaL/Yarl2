...
static class Constants
{
  ...
  //public static readonly Glyph BLANK_GLYPH = new(' ', Colours.BLACK, Colours.BLACK, Colours.BLACK, false);
...
static class Util
{
  ...
  public static Glyph TileToGlyph(Tile tile) => tile.Type switch
  {
    ...
    TileType.DungeonFloor or TileType.MoonDaughterSpot or TileType.CKShrineFoyer => new Glyph('.', Colours.GREY, Colours.GREY, Colours.BLACK, true),
    ...
    TileType.SecretPassage => new Glyph('#', Colours.GREY, Colours.DARK_GREY, Colours.BLACK, false),
    ...
    TileType.Gravestone => new Glyph('\u25AE', Colours.GREY, Colours.DARK_GREY, Colours.BLACK, false),
    TileType.DisturbedGrave => new Glyph('|', Colours.GREY, Colours.DARK_GREY, Colours.BLACK, false),
    ...
    TileType.BarredStairway => new Glyph('>', Colours.YELLOW, Colours.YELLOW_ORANGE, Colours.BLACK, false),
