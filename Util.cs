...
class Util
{
  ...
  public static Glyph TileToGlyph(Tile tile) => tile.Type switch
  {
    ...
    TileType.HiddenTrapDoor => new Glyph('.', Colours.YELLOW, Colours.GREY, Colours.TORCH_ORANGE, Colours.BLACK),
    TileType.TrapDoor => new Glyph('^', Colours.YELLOW, Colours.GREY, Colours.BLACK, Colours.BLACK),
