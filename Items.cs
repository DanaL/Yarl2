...
enum ItemNames
{
  ...
  FLASK_OF_BOOZE, FROST_GIANT_ESSENCE, GASTON_BADGE, GHOSTCAP_MUSHROOM, GOLDEN_APPLE, GREATSWORD, GUIDE_STABBY, 
  GUIDE_AXES, GUIDE_BOWS, GUIDE_SWORDS, GUISARME, HAND_AXE, HEAVY_BOOTS, HELMET, HILL_GIANT_ESSENCE, LEATHER_ARMOUR, 
  LEATHER_GLOVES, LESSER_BURLY_CHARM, LESSER_GRACE_CHARM, LESSER_HEALTH_CHARM,  LOCK_PICK, LONGBOW, LONGSWORD, MACE, 
  MITHRIL_ORE, OGRE_LIVER, PICKAXE, POTION_BLINDNESS, POTION_COLD_RES, POTION_FIRE_RES, POTION_HEALING, POTION_MIND_READING, 
