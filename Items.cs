...
enum ItemNames
{
  ...
  LEATHER_ARMOUR, LESSER_BURLY_CHARM, LESSER_HEALTH_CHARM, LOCK_PICK, LONGBOW, LONGSWORD, MACE, 
  OGRE_LIVER, PICKAXE, POTION_BLINDNESS, POTION_COLD_RES, POTION_FIRE_RES, POTION_HEALING, 
