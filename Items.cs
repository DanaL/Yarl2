...
enum ItemNames
{
  ANTIDOTE, ANTISNAIL_SANDALS, APPLE, ARROW, BATTLE_AXE, BEETLE_CARAPACE, BLINDFOLD, CAMPFIRE, CHAINMAIL, 
  CLAYMORE, DAGGER, DART, FIRE_GIANT_ESSENCE, FIREBOLT, FROST_GIANT_ESSENCE, GASTON_BADGE, GHOSTCAP_MUSHROOM, 
  GREATSWORD, GUIDE_STABBY, GUIDE_AXES, GUIDE_SWORDS, GUISARME, HAND_AXE, HEAVY_BOOTS, HELMET,
  HILL_GIANT_ESSENCE, LEATHER_ARMOUR, LESSER_BURLY_CHARM, LESSER_HEALTH_CHARM, LOCK_PICK, LONGBOW, LONGSWORD, 
  MACE, OGRE_LIVER, PICKAXE, POTION_BLINDNESS, POTION_COLD_RES, POTION_FIRE_RES, POTION_HEALING, 
  POTION_MIND_READING, POTION_OF_LEVITATION, RAPIER, RING_OF_ADORNMENT, RING_OF_AGGRESSION, 
  RING_OF_FRAILITY, RING_OF_PROTECTION, RINGMAIL, RUBBLE, SCROLL_BLINK, SCROLL_IDENTIFY, SCROLL_KNOCK, 
  SCROLL_MAGIC_MAP, SCROLL_PROTECTION, SCROLL_RECALL, SHIELD, SHORTSHORD, SILVER_DAGGER, SILVER_LONGSWORD, 
  SKULL, SPEAR, STATUE, STUDDED_LEATHER_ARMOUR, TALISMAN_OF_CIRCUMSPECTION, TORCH, VIAL_OF_POISON, 
  WAND_FIREBALLS, WAND_FROST, WAND_HEAL_MONSTER, WAND_MAGIC_MISSILES, WAND_SWAP, ZORKMIDS, ZORKMIDS_GOOD, 
