...
enum ItemNames
{
  ...
  CHAINMAIL, CLAYMORE, CLOAK_OF_PROTECTION, CROESUS_CHARM, CUTPURSE_CREST, DAGGER, DART, FEATHERFALL_BOOTS, FIRE_GIANT_ESSENCE, 
  FIREBOLT, FLASK_OF_BOOZE, FROST_GIANT_ESSENCE, GASTON_BADGE, GAUNTLETS_OF_POWER, GENERIC_WAND, GHOSTCAP_MUSHROOM, 
  GOLDEN_APPLE, GREATSWORD, GUIDE_STABBY, GUIDE_AXES, GUIDE_BOWS, GUIDE_SWORDS, GUISARME, HAND_AXE, HEAVY_BOOTS, HELMET, 
  HILL_GIANT_ESSENCE, HOLY_WATER, LEATHER_ARMOUR, LEATHER_GLOVES, LESSER_BURLY_CHARM, LESSER_GRACE_CHARM, LESSER_HEALTH_CHARM, 
  LOCK_PICK, LONGBOW, LONGSWORD, MACE, MEDITATION_CRYSTAL, MITHRIL_ORE, MUSHROOM_STEW, OGRE_LIVER, PICKAXE, POTION_BLINDNESS, 
  POTION_COLD_RES, POTION_FIRE_RES, POTION_HEALING, POTION_HEROISM, POTION_MIND_READING, POTION_OF_LEVITATION, POTION_OBSCURITY, 
  QUARTERSTAFF, RAPIER, RING_OF_ADORNMENT, RING_OF_AGGRESSION, RING_OF_FRAILITY, RING_OF_PROTECTION, RINGMAIL, RUBBLE, 
  SCROLL_BLINK, SCROLL_DISARM, SCROLL_IDENTIFY, SCROLL_KNOCK, SCROLL_MAGIC_MAP, SCROLL_PROTECTION, SCROLL_RECALL, SCROLL_SCATTERING, 
  SCROLL_TRAP_DETECTION, SCROLL_TREASURE_DETECTION, SEEWEED, SHIELD, SHORTSHORD, SILVER_DAGGER, SILVER_LONGSWORD, SKELETON_KEY, 
  SKULL, SMOULDERING_CHARM, SPEAR, STATUE, STONE_ALTAR, STUDDED_LEATHER_ARMOUR, TALISMAN_OF_CIRCUMSPECTION, TORCH, TROLL_BROOCH, 
  VIAL_OF_POISON, WAND_DIGGING, WAND_FIREBALLS, WAND_FROST, WAND_HEAL_MONSTER, WAND_MAGIC_MISSILES, WAND_SLOW_MONSTER, 
  WAND_SUMMONING, WAND_SWAP, WIND_FAN, ZORKMIDS, ZORKMIDS_GOOD, ZORKMIDS_MEDIOCRE, ZORKMIDS_PITTANCE,
