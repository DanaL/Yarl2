...
enum ItemNames
{
  ...
  STONE_ALTAR, STUDDED_LEATHER_ARMOUR, SULPHUROUS_ASH, TALISMAN_OF_CIRCUMSPECTION, TINCTURE_CELERITY, TORCH, TROLL_BROOCH, 
  VIAL_OF_POISON, VIAL_SPRITE_BLOOD, WAND_DIGGING, WAND_FIREBALLS, WAND_FROST, WAND_HEAL_MONSTER, WAND_MAGIC_MISSILES, WAND_SLEEP, 
  WAND_SLOW_MONSTER, WAND_SUMMONING, WAND_SWAP, WIND_FAN, WOOL_CLOAK, YENDORIAN_SODA, ZORKMIDS, ZORKMIDS_GOOD, ZORKMIDS_MEDIOCRE, 
  ZORKMIDS_PITTANCE,
