...
enum ItemType
{
  ...
  Illusion, Device, Altar, Column, Ink, Arrow, Component, SpellBook
}
...
enum ItemNames
{
  ...
  BLINDFOLD, BLOOD_MOSS, BOMB, BONE,  BOOTS_OF_WATER_WALKING, CAMPFIRE, CHAINMAIL, CLAYMORE, CLOAK_OF_PROTECTION, COLUMN, 
  CRIMSON_KING_WARD, CROESUS_CHARM, CUTPURSE_CREST, DAGGER, DART, EMERGENCY_DOOR, FEARFUL_RUNE, FEATHERFALL_BOOTS, FIRE_GIANT_ESSENCE, 
  FIREBOLT, FIREBURST_ARROW, FLASK_OF_BOOZE, FROST_GIANT_ESSENCE, GARLIC, GASTON_BADGE, GAUNTLETS_OF_POWER, GHOSTCAP_MUSHROOM, 
  ...
  LESSER_HEALTH_CHARM, LOCK_PICK, LONGBOW, LONGSWORD, MANDRAKE_ROOT, MACE, MEDITATION_CRYSTAL, MITHRIL_ORE, MOON_LYRE, MOON_MANTLE, 
  MUSHROOM_STEW, NIGHTSHADE, OGRE_LIVER, PHALANX_PHOLIO_2, PICKAXE, POTION_BLINDNESS, POTION_CLARITY, POTION_COLD_RES, POTION_DESCENT, 
  ...
  SNEAKERS, SNOWBURST_ARROW, SPEAR, SPELLBOOK_ERSATZ_ELEVATOR, SPELLBOOK_MAGE_ARMOUR, SPELLBOOK_PHASE_DOOR, SPIDER_ARROW, SPIDER_SILK, 
  STATUE, STONE_ALTAR, STUDDED_LEATHER_ARMOUR, SULPHUROUS_ASH, TALISMAN_OF_CIRCUMSPECTION, TINCTURE_CELERITY, TORCH, TROLL_BROOCH, 
