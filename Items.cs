...
enum ItemNames
{
  ...
  LOCK_PICK, LONGBOW, LONGSWORD, MACE, MEDITATION_CRYSTAL, MITHRIL_ORE, MUSHROOM_STEW, OGRE_LIVER, PICKAXE, 
  POTION_BLINDNESS, POTION_COLD_RES, POTION_FIRE_RES, POTION_HEALING, POTION_HEROISM, POTION_MIND_READING, 
  POTION_OF_LEVITATION, QUARTERSTAFF, RAPIER, RING_OF_ADORNMENT, RING_OF_AGGRESSION, RING_OF_FRAILITY, 
  RING_OF_PROTECTION, RINGMAIL, RUBBLE, SCROLL_BLINK, SCROLL_DISARM, SCROLL_IDENTIFY, SCROLL_KNOCK, SCROLL_MAGIC_MAP, 
  SCROLL_PROTECTION, SCROLL_RECALL, SCROLL_TRAP_DETECTION, SCROLL_TREASURE_DETECTION, SHIELD, SHORTSHORD, SILVER_DAGGER, 
  SILVER_LONGSWORD, SKULL, SMOULDERING_CHARM, SPEAR, STATUE, STUDDED_LEATHER_ARMOUR, TALISMAN_OF_CIRCUMSPECTION, TORCH, 
  TROLL_BROOCH, VIAL_OF_POISON, WAND_FIREBALLS, WAND_FROST, WAND_HEAL_MONSTER, WAND_MAGIC_MISSILES, WAND_SLOW_MONSTER, 
