...
enum ItemNames
{
  ...
  POTION_FIRE_RES, POTION_HEALING, POTION_HEROISM, POTION_MIND_READING, POTION_OF_LEVITATION, RAPIER, RING_OF_ADORNMENT, 
  RING_OF_AGGRESSION, RING_OF_FRAILITY, RING_OF_PROTECTION, RINGMAIL, RUBBLE, SCROLL_BLINK, SCROLL_DISARM, SCROLL_IDENTIFY, 
  SCROLL_KNOCK, SCROLL_MAGIC_MAP, SCROLL_PROTECTION, SCROLL_RECALL, SHIELD, SHORTSHORD, SILVER_DAGGER, SILVER_LONGSWORD, 
  SKULL, SMOULDERING_CHARM, SPEAR, STATUE, STUDDED_LEATHER_ARMOUR, TALISMAN_OF_CIRCUMSPECTION, TORCH, TROLL_BROOCH, 
