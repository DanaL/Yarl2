...
enum ItemNames
{
  ...
  POTION_BLINDNESS, POTION_COLD_RES, POTION_FIRE_RES, POTION_HEALING, POTION_HEROISM, POTION_MIND_READING, POTION_OF_LEVITATION,
  POTION_OBSCURITY, QUARTERSTAFF, RAPIER, RING_OF_ADORNMENT, RING_OF_AGGRESSION, RING_OF_FRAILITY, RING_OF_PROTECTION, RINGMAIL,
  RUBBLE, SCROLL_BLINK, SCROLL_DISARM, SCROLL_IDENTIFY, SCROLL_KNOCK, SCROLL_MAGIC_MAP, SCROLL_PROTECTION, SCROLL_RECALL,
  SCROLL_SCATTERING, SCROLL_TRAP_DETECTION, SCROLL_TREASURE_DETECTION, SEEWEED, SHIELD, SHORTSHORD, SILVER_DAGGER,
