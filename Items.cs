...
enum ItemNames
{
  ...
  VIAL_OF_POISON, WAND_FIREBALLS, WAND_FROST, WAND_HEAL_MONSTER, WAND_MAGIC_MISSILES, WAND_SWAP, ZORKMIDS, 
  ZORKMIDS_GOOD, ZORKMIDS_MEDIOCRE, ZORKMIDS_PITTANCE, FLASK_OF_BOOZE
}
