...
enum ItemNames
{
  ...
  GUISARME, HAND_AXE, HEARTY_SOUP, HEAVY_BOOTS, HELMET, HILL_GIANT_ESSENCE, HOLY_WATER, LEATHER_ARMOUR, LEATHER_GLOVES, LESSER_BURLY_CHARM,
  LESSER_GRACE_CHARM, LESSER_HEALTH_CHARM, LOCK_PICK, LONGBOW, LONGSWORD, MACE, MEDITATION_CRYSTAL, MITHRIL_ORE, MUSHROOM_STEW,
  OGRE_LIVER, PICKAXE, POTION_BLINDNESS, POTION_COLD_RES, POTION_DESCENT, POTION_FIRE_RES, POTION_HARDINESS, POTION_HEALING,
