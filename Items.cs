...
enum ItemNames
{
  ...
  SNEAKERS, SNOWBURST_ARROW, SPEAR, SPELLBOOK_MAGE_ARMOUR, SPIDER_ARROW, SPIDER_SILK, STATUE, STONE_ALTAR, STUDDED_LEATHER_ARMOUR, 
  SULPHUROUS_ASH, TALISMAN_OF_CIRCUMSPECTION, TINCTURE_CELERITY, TORCH, TROLL_BROOCH, VIAL_OF_POISON, VIAL_SPRITE_BLOOD, WAND_DIGGING, 
  WAND_FIREBALLS, WAND_FROST, WAND_HEAL_MONSTER, WAND_MAGIC_MISSILES, WAND_SLEEP, WAND_SLOW_MONSTER, WAND_SUMMONING, WAND_SWAP, WIND_FAN, 
