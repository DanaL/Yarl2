...
enum ItemNames
{
  ...
  GLOVES_OF_ARCHERY, GOLDEN_APPLE, GREATSWORD, GUIDE_STABBY, GUIDE_AXES, GUIDE_BOWS, GUIDE_SWORDS, GUISARME, HALFLING_CUPCAKE, 
  HAND_AXE, HEARTY_SOUP, HEAVY_BOOTS, HELMET, HILL_GIANT_ESSENCE, HOLY_WATER, KNOCKBACK_ARROW, LEATHER_ARMOUR, LEATHER_GLOVES, 
  LEMBAS, LESSER_BURLY_CHARM, LESSER_GRACE_CHARM, LESSER_HEALTH_CHARM, LOCK_PICK, LONGBOW, LONGSWORD, MACE, MEDITATION_CRYSTAL, 
  MITHRIL_ORE, MOON_LYRE, MOON_MANTLE, MUSHROOM_STEW, OGRE_LIVER, PHALANX_PHOLIO_2, PICKAXE, POTION_BLINDNESS, POTION_CLARITY, 
  POTION_COLD_RES, POTION_DESCENT, POTION_DRAGON_BREATH, POTION_FIRE_RES, POTION_FORGETFULNESS, POTION_HEALING, POTION_HEROISM, 
  POTION_MIND_READING, POTION_OF_LEVITATION, POTION_OBSCURITY, QUARTERSTAFF, RAPIER, RING_OF_ADORNMENT, RING_OF_PROTECTION, 
  RING_OF_WATER_BREATHING, RINGMAIL, RUBBLE, SCROLL_BLINK, RUNE_OF_LASHING, RUNE_OF_PARRYING, SCROLL_ENCHANTING, SCROLL_ESCAPE, 
  SCROLL_DISARM, SCROLL_KNOCK, SCROLL_MAGIC_MAP, SCROLL_PROTECTION, SCROLL_SCATTERING, SCROLL_STAINLESS, SCROLL_TRAP_DETECTION, 
  SCROLL_TREASURE_DETECTION, SEEWEED, SHIELD, SHORTBOW, SHORTSHORD, SILVER_ARROW, SILVER_DAGGER, SILVER_LONGSWORD, SKELETON_KEY, 
  SKULL, SMOULDERING_CHARM, SNEAKERS, SNOWBURST_ARROW, SPEAR, SPIDER_ARROW, STATUE, STONE_ALTAR, STUDDED_LEATHER_ARMOUR, 
  TALISMAN_OF_CIRCUMSPECTION, TINCTURE_CELERITY, TORCH, TROLL_BROOCH, VIAL_OF_POISON, VIAL_SPRITE_BLOOD, WAND_DIGGING, 
  WAND_FIREBALLS, WAND_FROST, WAND_HEAL_MONSTER, WAND_MAGIC_MISSILES, WAND_SLOW_MONSTER, WAND_SUMMONING, WAND_SWAP, WIND_FAN, 
  WOOL_CLOAK, YENDORIAN_SODA, ZORKMIDS, ZORKMIDS_GOOD, ZORKMIDS_MEDIOCRE, ZORKMIDS_PITTANCE, 
