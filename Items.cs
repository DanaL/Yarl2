...
enum ItemNames
{
  ...
  GHOSTCAP_MUSHROOM, GOLDEN_APPLE, GREATSWORD, GUIDE_STABBY, GUIDE_AXES, GUIDE_SWORDS, GUISARME, HAND_AXE, 
  HEAVY_BOOTS, HELMET, HILL_GIANT_ESSENCE, LEATHER_ARMOUR, LESSER_BURLY_CHARM, LESSER_HEALTH_CHARM, LOCK_PICK, 
  LONGBOW, LONGSWORD, MACE, OGRE_LIVER, PICKAXE, POTION_BLINDNESS, POTION_COLD_RES, POTION_FIRE_RES, 
