...
enum ItemNames
{
  ...
  RING_OF_PROTECTION, RINGMAIL, RUBBLE, SCROLL_BLINK, SCROLL_IDENTIFY, SCROLL_KNOCK, SCROLL_MAGIC_MAP, 
  SCROLL_PROTECTION, SCROLL_RECALL, SHIELD, SHORTSHORD, SILVER_DAGGER, SILVER_LONGSWORD, SKULL, SPEAR, 
  STATUE, STUDDED_LEATHER_ARMOUR, TALISMAN_OF_CIRCUMSPECTION, TORCH, VIAL_OF_POISON, WAND_FIREBALLS, 
  WAND_FROST, WAND_HEAL_MONSTER, WAND_MAGIC_MISSILES, WAND_SWAP, ZORKMIDS, ZORKMIDS_GOOD, 
