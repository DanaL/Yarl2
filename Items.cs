...
enum ItemNames
{
  ...
  HAND_AXE, HEAVY_BOOTS, HELMET, HILL_GIANT_ESSENCE, LEATHER_ARMOUR, LESSER_BURLY_CHARM, LESSER_HEALTH_CHARM, 
  LOCK_PICK, LONGBOW, LONGSWORD, MACE, OGRE_LIVER, PICKAXE, POTION_BLINDNESS, POTION_COLD_RES, POTION_FIRE_RES, 
  POTION_HEALING, POTION_MIND_READING, POTION_OF_LEVITATION, RAPIER, RING_OF_ADORNMENT, RING_OF_AGGRESSION, 
  RING_OF_FRAILITY, RING_OF_PROTECTION, RINGMAIL, RUBBLE, SCROLL_BLINK, SCROLL_DISARM, SCROLL_IDENTIFY, 
  SCROLL_KNOCK, SCROLL_MAGIC_MAP, SCROLL_PROTECTION, SCROLL_RECALL, SHIELD, SHORTSHORD, SILVER_DAGGER, 
  SILVER_LONGSWORD, SKULL, SPEAR, STATUE, STUDDED_LEATHER_ARMOUR, TALISMAN_OF_CIRCUMSPECTION, TORCH, 
