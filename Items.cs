...
enum ItemNames
{
  ...
  MUSHROOM_STEW, OGRE_LIVER, PICKAXE, POTION_BLINDNESS, POTION_COLD_RES, POTION_DESCENT, POTION_DRAGON_BREATH, POTION_FIRE_RES, POTION_HARDINESS, 
  POTION_HEALING, POTION_HEROISM, POTION_MIND_READING, POTION_OF_LEVITATION, POTION_OBSCURITY, QUARTERSTAFF, RAPIER, RING_OF_ADORNMENT,
  RING_OF_PROTECTION, RING_OF_WATER_BREATHING, RINGMAIL, RUBBLE, SCROLL_BLINK, RUNE_OF_LASHING, RUNE_OF_PARRYING, SCROLL_ENCHANTING, 
  SCROLL_ESCAPE, SCROLL_DISARM, SCROLL_KNOCK, SCROLL_MAGIC_MAP, SCROLL_PROTECTION, SCROLL_SCATTERING, SCROLL_STAINLESS, SCROLL_TRAP_DETECTION, 
  SCROLL_TREASURE_DETECTION, SEEWEED, SHIELD, SHORTSHORD, SILVER_DAGGER, SILVER_LONGSWORD, SKELETON_KEY, SKULL, SMOULDERING_CHARM, 
  SPEAR, STATUE, STONE_ALTAR, STUDDED_LEATHER_ARMOUR, TALISMAN_OF_CIRCUMSPECTION, TINCTURE_CELERITY, TORCH, TROLL_BROOCH, VIAL_OF_POISON,
  WAND_DIGGING, WAND_FIREBALLS, WAND_FROST, WAND_HEAL_MONSTER, WAND_MAGIC_MISSILES, WAND_SLOW_MONSTER, WAND_SUMMONING, WAND_SWAP, WIND_FAN,
