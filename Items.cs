...
enum ItemNames
{
  ...
  HAND_AXE, HEARTY_SOUP, HEAVY_BOOTS, HELMET, HILL_GIANT_ESSENCE, HOLY_WATER, KNOCKBACK_ARROW, LEATHER_ARMOUR, LEATHER_BOOTS, 
  LEATHER_GLOVES, LEMBAS, LESSER_BURLY_CHARM, LESSER_GRACE_CHARM, LESSER_HEALTH_CHARM, LOCK_PICK, LONGBOW, LONGSWORD, MACE, 
  MEDITATION_CRYSTAL, MITHRIL_ORE, MOON_LYRE, MOON_MANTLE, MUSHROOM_STEW, OGRE_LIVER, PHALANX_PHOLIO_2, PICKAXE, POTION_BLINDNESS, 
  ...
  SCROLL_ESCAPE, SCROLL_DISARM, SCROLL_KNOCK, SCROLL_MAGIC_MAP, SCROLL_PROTECTION, SCROLL_SCATTERING, SCROLL_STAINLESS, 
