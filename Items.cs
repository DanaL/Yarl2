...
enum ItemNames
{
  ...
  CAMPFIRE, CHAINMAIL, CLAYMORE, CLOAK_OF_PROTECTION, CROESUS_CHARM, CUTPURSE_CREST, DAGGER, DART, FIRE_GIANT_ESSENCE, 
  FIREBOLT, FLASK_OF_BOOZE, FROST_GIANT_ESSENCE, GASTON_BADGE, GAUNTLETS_OF_POWER, GENERIC_WAND, GHOSTCAP_MUSHROOM, 
  GOLDEN_APPLE, GREATSWORD, GUIDE_STABBY, GUIDE_AXES, GUIDE_BOWS, GUIDE_SWORDS, GUISARME, HAND_AXE, HEAVY_BOOTS, 
  HELMET, HILL_GIANT_ESSENCE, LEATHER_ARMOUR, LEATHER_GLOVES, LESSER_BURLY_CHARM, LESSER_GRACE_CHARM, 
  ...
  POTION_MIND_READING, POTION_OF_LEVITATION, QUARTERSTAFF, RAPIER, RING_OF_ADORNMENT, RING_OF_AGGRESSION, 
  ...
  STUDDED_LEATHER_ARMOUR, TALISMAN_OF_CIRCUMSPECTION, TORCH, TROLL_BROOCH, VIAL_OF_POISON, WAND_FIREBALLS, WAND_FROST, 
  WAND_HEAL_MONSTER, WAND_MAGIC_MISSILES, WAND_SLOW_MONSTER, WAND_SUMMONING, WAND_SWAP, ZORKMIDS, ZORKMIDS_GOOD, 
