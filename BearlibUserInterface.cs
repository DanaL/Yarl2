...
internal class BLUserInterface : UserInterface, IDisposable
{
  ...
  void SetUpKeyToCharMap()
  {
    ...
    KeyToChar.Add((int)TKCodes.InputEvents.TK_UP, Constants.ARROW_N);
    KeyToChar.Add((int)TKCodes.InputEvents.TK_DOWN, Constants.ARROW_S);
    KeyToChar.Add((int)TKCodes.InputEvents.TK_LEFT, Constants.ARROW_W);
    KeyToChar.Add((int)TKCodes.InputEvents.TK_RIGHT, Constants.ARROW_E);
    KeyToChar.Add((int)TKCodes.InputEvents.TK_KP_1, Constants.ARROW_SW);
    ...
    KeyToChar.Add((int)TKCodes.InputEvents.TK_KP_9, Constants.ARROW_NE);
